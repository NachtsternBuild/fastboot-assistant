...
void instruction_others(int argc, char *argv[])
{
	...
	label_others_3 = gtk_label_new("Diese Partition dient der Kontrolle des Startvorgangs \ndes Androids. 'vbmeta' soll sicherstellen, \ndass der Startvorgang sicher abläuft. \nManche Custom-ROMs lassen sich nur \nstarten wenn ein neues vbmeta-Abbild geflasht wurde.");
