...
void remove_old_function(const char *option) 
{
    ...
    {
        title = "Remove Update-Verzeichnis";
    ...
    {
        title = "Remove files in ROM-Install";
...
void remove_old(int argc, char *argv[]) 
{
    ...
    gtk_window_set_title(GTK_WINDOW(window), "Remove");
    ...
    GtkWidget *button_files_rom_install = gtk_button_new_with_label("Files in ROM-Install");
