...
void instruction_recovery(GtkWidget *widget, gpointer stack) 
{
    ...
    // new button
    GtkWidget *button_reco_1 = create_button_icon_no_callback("pan-end-symbolic", next_page_char);
    GtkWidget *button_reco_2 = create_button_icon_no_callback("application-exit-symbolic", exit_page_char);
    ...
    // new button
    GtkWidget *button_reco_3 = create_button_icon_no_callback("pan-start-symbolic", back_page_char);
    GtkWidget *button_reco_4 = create_button_icon_no_callback("application-exit-symbolic", exit_page_char);
