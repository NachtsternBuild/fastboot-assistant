...
void instruction_custom_rom(GtkWidget *widget, gpointer stack) 
{
    ...
    // new button
    GtkWidget *button_rom2 = create_button_icon_no_callback("pan-end-symbolic", next_page_char);
    GtkWidget *button_rom3 = create_button_icon_no_callback("application-exit-symbolic", exit_page_char);
    ...
    // new button
    GtkWidget *button_rom5 = create_button_icon_no_callback("pan-start-symbolic", back_page_char);
    GtkWidget *button_rom6 = create_button_icon_no_callback("application-exit-symbolic", exit_page_char);
	...
	LOGD("end instruction_custom_rom");
}
