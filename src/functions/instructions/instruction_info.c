...
void instruction_info(GtkWidget *widget, gpointer stack) 
{
    ...
    // new button
    GtkWidget *button_info_1 = create_button_icon_no_callback("pan-end-symbolic", next_page_char);
    GtkWidget *button_info_2 = create_button_icon_no_callback("application-exit-symbolic", exit_page_char);
    ...
    // new button
    GtkWidget *button_info_3 = create_button_icon_no_callback("pan-end-symbolic", next_page_char);
    GtkWidget *button_info_4 = create_button_icon_no_callback("pan-start-symbolic", back_page_char);
    ...
    // new button
    GtkWidget *button_info_5 = create_button_icon_no_callback("pan-end-symbolic", next_page_char);
    GtkWidget *button_info_6 = create_button_icon_no_callback("pan-start-symbolic", back_page_char);
    ...
    // new button
    GtkWidget *button_info_7 = create_button_icon_no_callback("pan-start-symbolic", back_page_char);
    GtkWidget *button_info_8 = create_button_icon_no_callback("application-exit-symbolic", exit_page_char);
