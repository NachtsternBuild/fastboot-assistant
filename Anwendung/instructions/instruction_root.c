...
void instruction_root(int argc, char *argv[]) 
{
    ...
    gtk_label_set_markup(GTK_LABEL(inst5_label), g_strdup_printf("<b><u> Root Info </u></b>"));
    ...
    gtk_label_set_markup(GTK_LABEL(inst6_label), g_strdup_printf("<b><u> Root via Magisk </u></b>"));
    gtk_container_add(GTK_CONTAINER(vbox), inst6_label);
    
    // show-text
    GtkWidget *inst7_label = gtk_label_new(NULL);
    gtk_label_set_markup(GTK_LABEL(inst7_label), g_strdup_printf("Laden sie die Magisk-APK herunter via: \n<u><b>https://github.com/topjohnwu/Magisk/releases/download/v27.0/Magisk-v27.0.apk</u></b>"));
